...
tap.test('native-sprintf', function (t) {
  t.test('should return formated strings for simple placeholders', function (assert) {
  ...
  t.test('should return formated strings for complex placeholders', function (assert) {
    // sign
    assert.equal('2', sprintf('%d', 2))
    assert.equal('-2', sprintf('%d', -2))
    assert.equal('+2', sprintf('%+d', 2))
  ...
  t.test('should return formated strings for callbacks', function (assert) {
